export const getFilmCardTemplate = ({title, imageFileName, raiting, year, duration, genres, description, totalComments}) => `
<article class="film-card">
  ...
  <a class="film-card__comments">${totalComments} ${totalComments === 1 ? `comment` : `comments`}</a>
